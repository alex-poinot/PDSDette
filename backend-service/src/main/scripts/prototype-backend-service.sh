...
MAIN_CLASS="episen.backend.prototype.BackendService"
...
exec java -cp /home/tata/Alex/backend-service-1.0-SNAPSHOT-jar-with-dependencies.jar episen.backend.prototype.BackendService $*